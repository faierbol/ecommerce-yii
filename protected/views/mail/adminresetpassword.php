						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; ">
									<?php echo Yii::t('app','Your password has been reseted for some Security Reasons.'); ?>
								</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app','We have reseted your old password for some security reasons. The new password is provided along with this email. Please use the new password to login your account and change your password manually for security purpose.'); ?>
									</p>
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app','Here is your new password:'); ?> <?php echo $password; ?>
									</p>
									<p style='margin-bottom: 10px'>
