						...
						<tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app',"There is an order placed in your profile. This email confirms that 
									...
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app','You have options to confirm this order and mark is as processing. 
