			...
			<table cellpadding="0" cellspacing="0" border="0"
				...
				<tr>
					<td style="padding: 18px 0 0;" align="left">
						<h2 style="font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; 
							...
							<?php echo $followername.' '; ?><?php echo Yii::t('app','Now Following You'); ?>
							.
						</h2>
					</td>
				</tr>
				...
				<tr>
					<td style="padding: 15px 0;" valign="top">
						...
						<p style='margin-bottom: 10px'><?php echo Yii::t('app','Stay Connected!'); ?></p>
						<p style='margin-bottom: 10px'><?php echo Yii::t('app','There is an alot of products and friends waiting for you.'); ?></p>
						
						<p style='margin-bottom: 10px'>You have options to follow back. <?php echo Yii::t('app','Regards,'); ?></p>
