						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; 
									...
									<?php echo Yii::t('app','Your order shipping confirmation - The order ID(s)')." ".$orderId; ?>.
								</h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										 <?php echo Yii::t('app','Thank you for shopping on'); ?> <?php echo $siteSettings->sitename; ?> 
										 <?php echo Yii::t('app','! Kindly note down the order ID(s) '); ?> 
										<?php echo $orderId; ?> <?php echo Yii::t('app','as a reference number for this purchase.'); ?>
									</p>
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app','Your order is shipped. The same has been notified to the seller 
										too. In case if you have ordered multiple items from multiple sellers, all your orders may be 
										delivered separately. All your orders can be seen and tracked through 
										your'); ?> <?php echo $siteSettings->sitename; ?> <?php echo Yii::t('app','account also.'); ?>
									</p>
									<p style='margin-bottom: 10px'>
									...
									<p style='margin-bottom: 10px'>
										<?php
										echo 'Seller Name :';
											echo '<a href="'.Yii::app()->createAbsoluteUrl('user/profiles/',array('id'=> Myclass::safe_b64encode($sellerId.'-'.rand(0,999)))).'">'.$sellerName.'</a>,';
									...
									<p style='margin-bottom: 10px'>
										<table width="100%" class='order-details-table' style='border-spacing: 0;border-collapse: collapse;border: none;'>
										  <tr>
										    <th style='padding: 6px 10px;border: 1px solid rgba(0, 0, 0, 0.12);'><?php echo Yii::t('app','Subject'); ?></th>
										    <th style='padding: 6px 10px;border: 1px solid rgba(0, 0, 0, 0.12);'><?php echo Yii::t('app','Message'); ?></th>
										  </tr>
										  <tr>
										
											<td style='padding: 6px 10px;border: 1px solid rgba(0, 0, 0, 0.12);'><?php echo $subject; ?></td>
											<td style='padding: 6px 10px;border: 1px solid rgba(0, 0, 0, 0.12);text-align: center;'><?php echo $message; ?></td>
										  </tr>
										</table>
									</p>
									<p style='margin-bottom: 10px'>
										<b><?php echo Yii::t('app','Shipped to:'); ?></b>
										<br clear="all" /><br />
									...
									<p style='margin-bottom: 10px'>
										 <?php echo Yii::t('app','Your order is safe and been monitored closely with the seller when 
										you shop on'); ?><?php echo $siteSettings->sitename; ?><?php echo Yii::t('app','. In case if you don’t 
										receive your order from the seller(s) or it is delivered in an unsatisfactory condition, 
										you can reach us through '); ?><?php echo $siteSettings->sitename; ?><?php echo Yii::t('app','. When you 
										write to us about any orders, please mention the order ID to get quick response 
										from the support team.'); ?>
									</p>
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app','It’s also recommended to update the system once you received the 
									...
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app','To update receipt of the order, please login to your account and go 
