					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "> <?php echo Yii::t('app','Hello');?> <?php echo $name; ?>,
                                <?php echo Yii::t('app','Your order has been marked as delivered.'); ?></h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app','Buyer has marked your order status as delivered. Amount will be paid by the admin for this order.'); ?>
									</p>
									<p style='margin-bottom: 10px'>
