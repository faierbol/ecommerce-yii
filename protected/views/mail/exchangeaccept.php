			...
			<table cellpadding="0" cellspacing="0" border="0"
				...
				<tr>
					<td style="padding: 18px 0 0;" align="left">
						<h2 style="font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; 
							...
							<?php echo $r_username.' '; ?><?php echo Yii::t('app','Now Accepted the Request to Exchange on your product.'); ?>
						</h2>
					</td>
				</tr>
				...
				<tr>
					<td style="padding: 15px 0;" valign="top">
						...
						<p style='margin-bottom: 10px'><?php echo Yii::t('app','The Request to your product for Exchange was accepted!'); ?></p>
