...
<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" style="font-family: Georgia, serif;" class="header">
      <tr>
        <td bgcolor="#FFFFFF" height="60" align="left">
			...
			<a rel="nofollow" target="_blank" href="<?php echo Yii::app()->createAbsoluteUrl('/'); ?>">
				<?php
				if(!empty($siteSettings->logo)){
					echo '<img src="'.Yii::app()->createAbsoluteUrl('media/logo/'.$siteSettings->logoDarkVersion).'" style="width: 130px;">';
				}else{
					echo '<img src="'.Yii::app()->createAbsoluteUrl('media/logo/logo.png').'" style="width: 130px;">';
				}
				?>
			</a>
