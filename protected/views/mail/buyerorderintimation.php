							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										<table width="100%" class='order-details-table' style='border-spacing: 0;border-collapse: collapse;border: none;'>
										  ...
										  <tr>
											...
											<?php }else { ?>
												<td style='padding: 6px 10px;border: 1px solid rgba(0, 0, 0, 0.12);text-align: center;'><?php echo $custom[2]; ?></td
											<?php } ?>
									...
									<p style='margin-bottom: 10px;font-size:16px;'>
										<?php $orderModel = Orders::model()->findByPk($orderId);?>
										<?php echo Yii::t('app','Total:'); ?> <b><?php echo $orderModel->totalCost; //echo $keyarray['mc_gross']." ".$keyarray['mc_currency']; ?></b>
									</p>
									<p style='margin-bottom: 10px'>
