...
class Resetpassword extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('userId, resetData, createdDate', 'required'),
			array('userId, createdDate', 'numerical', 'integerOnly'=>true),
			array('resetData', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('resetId, userId, resetData, createdDate, resetpassword, confirmpassword', 'safe', 'on'=>'search'),
		);
	}
