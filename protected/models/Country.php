 ...
 *
 * The followings are the available columns in table 'hts_country':
 ...
 * @property Shippingaddresses[] $shippingaddresses
 * @property Tempaddresses[] $tempaddresses
 */
class Country extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('countryId, code, country', 'safe', 'on'=>'search'),
		);
	}
