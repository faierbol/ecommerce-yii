...
class ReportitemController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Reportproducts']))
		{
			$model->attributes=$_POST['Reportproducts'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Reportproducts');
	...
	{
		$model=new Reportproducts('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Reportproducts']))
			$model->attributes=$_GET['Reportproducts'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='reportproducts-form')
		{
