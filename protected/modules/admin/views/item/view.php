<div id="page-wrapper">
	...
	'attributes'=>array(
		...
		'name',
				array('name' => 'description','value' => html_entity_decode($model->description)),//'description',
		...
		'views',
				...
				array('name' => 'instantBuy','visible' => $buynowvisible,'value' => ($model->instantBuy == 1) ? Yii::t('admin','Enabled') : Yii::t('admin','Disabled')),
				array('name' => 'paypalid','visible' => $buynowvisible,'value' => ($model->paypalid == '') ? 'NIL' :$model->paypalid ),
				),
				)); /* ?>
					<table id="yw0" class="detail-view table table-striped table-bordered table-hover">
						<tbody>
							<tr class="even">
