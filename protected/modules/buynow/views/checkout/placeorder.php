...
if($sitePaymentMode['scrowPaymentMode'] == 0){
	$businessEmail = $productModel->paypalid;
}else{
	$businessEmail = $paypalSettings['paypalEmailId'];
}
?>
...
<input
	...
	value="<?php echo Yii::app()->createAbsoluteUrl('/checkout/canceled'); ?>">
<input
	type="hidden" name="return"
	value="<?php echo Yii::app()->createAbsoluteUrl('/checkout/success'); ?>">
