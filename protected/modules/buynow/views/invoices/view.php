	...
	<div style="margin-left: 10px;" id="userdata">
		...
		<div class="buyerdiv">
			<div style="display: inline-block; float: left; width: 50%;"
				...
				<span
					style="color: #8D8D8D; font-size: 12px; margin-bottom: 0px; margin-top: 12px;"
					class="pay-status"><?php echo Yii::t('admin','Buyer Details'); ?></span><br> <span
					style="font-size: 14px; font-weight: bold;" class="pay-to"><?php echo $invoiceData['user']['username']; ?>
				</span><br> <span
					style="color: #8D8D8D; font-size: 12px; margin-bottom: 0px; margin-top: 12px;"
			...
			<div style="display: inline-block; width: 50%;" class="inv-shipping">
				<span
					style="color: #8D8D8D; font-size: 12px; margin-bottom: 0px; margin-top: 12px;"
					class="pay-status"><?php echo Yii::t('admin','Shipping Address'); ?></span><br>
		...
		<table style="border: 1px solid;" class="Item-details">
			<thead style="background-color: #D3D3D3; color: #4D4D4D;">
				<tr>
					...
					<th style="font-size: 14px;text-align:center;"><?php echo Yii::t('admin','Item Name'); ?></th>
					<th style="font-size: 14px;text-align:center;"><?php echo Yii::t('admin','Item Quantity'); ?></th>
					<th style="font-size: 14px;text-align:center;"><?php echo Yii::t('admin','Item Unitprice'); ?></th>
					<th style="font-size: 14px;text-align:center;"><?php echo Yii::t('admin','Shipping fee'); ?></th>
					<th style="font-size: 14px;text-align:center;"><?php echo Yii::t('admin','Total Price'); ?></th>
				</tr>
			</thead>
			<tbody>
				<tr>
