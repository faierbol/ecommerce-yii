 ...
 * v 0.2
 */
class ExtCKEditor extends CInputWidget{
    const COLS = 40;
    const ROWS = 10;
...
//advanced - пользователь сам определяет тулбар
    ...
    public function getLanguage(){
        return ($this->language != "") ? $this->language : Yii::app()->getLanguage();
    ...
    public function run(){
        ...
        //else if($this->language == 'ar')
            //$cs->registerScriptFile($assets.'/ckeditor-rtl.js');

        if($this->language == 'ar')
        {
            echo '<script type="text/javascript">var configlanguage = "ar";var configdirection="rtl"</script>';
        }
        else
        {
            echo '<script type="text/javascript">var configlanguage = "en";var configdirection="ltr"</script>';
        }
